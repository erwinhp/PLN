          ...
          <div class="card">
              ...
              <div class="card-body">
                <div class="panel-bSody">
                    ...
                    <div class="col-md-6">
                      <select class="form-control input-sm"name="idDes" value="<?php echo e(old('idDes')); ?>" required>
                        ...
                        <div class="form-group<?php echo e($errors->has('har_bes') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="Dusun" type="Dusun" class="form-control" name="Dusun" value="<?php echo e(old('Dusun')); ?>" required>
