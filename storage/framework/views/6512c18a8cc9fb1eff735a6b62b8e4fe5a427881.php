          ...
          <div class="card">
              ...
              <div class="card-body">
                <div class="panel-bSody">
                    <form class="form-horizontal" role="form" method="POST" action="/admin/des/<?php echo e($Des->id); ?>">
                    ...
                    <div class="col-md-6">
                      <select class="form-control input-sm"name="idKec" value="<?php echo e($Des->idKec); ?>" required>
                        ...
                        <div class="form-group<?php echo e($errors->has('har_bes') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="Des" type="Des" class="form-control" name="Des" value="<?php echo e($Des->Des); ?>" required>
