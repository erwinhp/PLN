          ...
          <div class="card">
              ...
              <div class="card-body">
                <div class="panel-bSody">
                    <form class="form-horizontal" role="form" method="post" action="/admin/kec/<?php echo e($kec->id); ?>" >
                    ...
                    <div class="col-md-6">
                      <select class="form-control input-sm"name="idKab" value="<?php echo e($kec->idKab); ?>" required>
                        ...
                        <div class="form-group<?php echo e($errors->has('har_bes') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="kecamatan" type="kecamatan" class="form-control" name="kecamatan" value="<?php echo e($kec->kecamatan); ?>" required>
